...

{
     ...
     * @return 
     */
    public AlteracaoDeSanidade ( String , int  )
    {
        // ## Implementation preserve start class method.AlteracaoDeSanidade@@@@String@int 
        // ## Implementation preserve end class method.AlteracaoDeSanidade@@@@String@int 
    }
    /**
     * Operation
     *
